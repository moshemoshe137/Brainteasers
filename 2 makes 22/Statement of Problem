Write an arithmetic expression using the number 2 exactly 7 times, using any of the following
...
operations from left to right without considering the rules of operator precedence.
So for instance:
